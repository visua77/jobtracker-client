...
const Account = ()=> {
    ...
    return(
        <div>
            ...
            {userData.user ? <>
            <p className="ninety"><strong>ID:</strong> {userData.user.id}</p>
            <p className="ninety"><strong>Username:</strong> {userData.user.name}</p>
            <p className="ninety"><strong>Email:</strong> <a href={`mailto:${userData.user.email}`}className="a-mail">{userData.user.email}</a></p>
            <form>
